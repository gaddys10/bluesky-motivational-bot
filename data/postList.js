export const posts = [
    ...
    "There is no healing. There is only letting go. #motivation",
    "Your breakthrough is on the other side of your consistency. #motivation",
    ...
    "imagine the come up story #motivation",
    ...
    "Stay patient and committed to the process. #motivation",
    ...
    "Make it so personal it becomes the business 👹 #motivation",
    ...
    "Trust in your preparation. #motivation",
    "Don't train to win \n\n train to dominate 👹",
    "The world is cruel \n\nBe more wickeda 👹 ",
    "No one ever made any progress waiting. #motivation",
    "You can manufacture luck through volume.",
    "You are more resilient than you think. #motivation",
    ...
    "Have a clear, meaningful goal to let yourself get a little crazy over #motivation",
    "Just do it and survive the outcome 👹 #motivation",
    "Unplanned action beats every unactioned plan. #motivation",
    ...
    "Accept the present and mold the future. #motivation",
    ...
    "Winners will always find a way to win. #motivation",
    ...
    "You must be prepared to discipline yourself to put in this hard work 👹 #motivation ",
    ...
    "Get rid of the distractions and see how much progress you’ll make #motivation",
    ...
    "Let go of the past",
    "You can get away with more than you think you can 👹 #motivation",
    ...
    "The year of try everything #motivation",
    "Creating anything worthwhile is like a marathon, and you must train for it.\n\n#motivation",
    "Find a way 👹 ",
    "Take the long road.",
    "bottom feeder mentality don't take you to the top #motivation",
